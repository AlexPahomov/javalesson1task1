...
- Дата начала: 25.11.2020 дата окончания: 25.0118.2020

На тестирование затрачено: 1.5 часа

### Что нужно проверить:
1. Инструкция по установке OpenJDK11 работает ли под ОС тестировщика
2. Приложение запускается и совместимо с Java 11
3. Приложение работает согласно руководству использования

### В результате тестирования выявлены следующие дефекты:

Следующие ключи из списка валидных оказались невалидными [bug report](https://github.com/AlexPahomov/javalesson1task1/issues/1):
- 80b427f8-92cd-3aae-ba04-3927fbe17c6

- 387eedc6-12e9-3b32-9881-63b6b5e85317

Следующие ключи из списка невалидных оказались валидными [bug report](https://github.com/AlexPahomov/javalesson1task1/issues/2)
...
Для валидных ключей: "Result for <ключ>: OK Для невалидных ключей: "Result for <ключ>: FAIL
...
Ноутбук - HP PAVILION 15, Windows 8.1, x64, Java version 11.0.9.1
